  ...
  <script type="text/javascript">
            ...
            // scatter points
            ...
            
             {
             	rank: 112,
             	eff: 438.54,
             	conf: 'SGI ICE X, Xeon E5-2680v4 14C 2.4GHz, Infiniband FDR',
             	color: '#A9A9A9'
             },
            ...
            
             {
             	rank: 250,
             	eff: 194.48,
             	conf: 'Intel Cluster, Intel Xeon Phi 7250F 68C 1.4GHz, Intel Omni-Path',
             	color: '#FF00FF'
             },
            ...
            
             {
             	rank: 267,
             	eff: 223.52,
             	conf: 'Intel Cluster, Xeon Gold 6148 20C 2.4GHz, Intel Omni-Path',
             	color: '#FF00FF'
             },
            ...
            
             {
             	rank: 271,
             	eff: 296.00,
             	conf: 'Huawei XH321 V3/XH620 V3 Cluster, Xeon E5-2680v4 14C 2.4GHz, Infiniband FDR',
             	color: '#9400D3'
             },
            ...
            
             {
             	rank: 358,
             	eff: 241.90,
             	conf: 'MEGWARE MiriQuid, Xeon E5-2630v4 10C 2.2GHz, Intel Omni-Path',
             	color: '#FF69B4'
             },
            ...
            
             {
             	rank: 396,
             	eff: 320.00,
             	conf: 'HC2000 Cluster, Xeon E5-2630v3 8C 2.4GHz, 10G Ethernet, NVIDIA Tesla K80',
             	color: '#00CED1'
             },
            ...
            
             {
             	rank: 404,
             	eff: 552.40,
             	conf: 'FusionServer RH1288 V3/XH620 V3, Intel Xeon E5-2680 v4/Xeon E5-2680v3 12C 2.5GHz, Infiniband FDR',
             	color: '#9400D3'
             },
            ...
            
             {
             	rank: 405,
             	eff: 95.48,
             	conf: 'PowerEdge C6320, Intel Xeon Phi 7210 64C 1.3GHz, Intel Omni-Path',
             	color: '#008B8B'
             },
            ...
            
             {
             	rank: 420,
             	eff: 243.26,
             	conf: 'Huawei E9000 Blade Server, Xeon E5-2680v4 14C 2.4GHz, Infiniband EDR, NVIDIA Tesla K80',
             	color: '#9400D3'
             },
            ...
            
             {
             	rank: 443,
             	eff: 240.00,
             	conf: 'CH121 V3 Cluster, Xeon E5-2690v3 12C 2.6GHz, Infiniband FDR',
             	color: '#9400D3'
             },
            ...
            
             {
             	rank: 462,
             	eff: 280.00,
             	conf: 'HC2000 Cluster, Xeon E5-2650v3 10C 2.3GHz, 10G Ethernet, NVIDIA Tesla K80',
             	color: '#00CED1'
             },
            ...
            
             {
             	rank: 466,
             	eff: 32.80,
             	conf: 'ZettaScaler-1.6 GPGPU system, Xeon E5-2650Lv4 14C 1.7GHz, Infiniband FDR, NVIDIA Tesla P100',
             	color: '#483D8B'
             },
            ...
            
             {
             	rank: 467,
             	eff: 69.00,
             	conf: 'IBM Power Systems S822LC, IBM Power8+ 10C 2.86GHz, Infiniband EDR, NVIDIA Tesla GP100',
             	color: '#00FFFF'
             },
            ...
            
             {
             	rank: 468,
             	eff: 199.05,
             	conf: 'Rackable C2112-4GP3 Cluster, Xeon E5-2695v4 18C 2.1GHz, Infiniband EDR',
             	color: '#A9A9A9'
             },
            ...
            
             {
             	rank: 475,
             	eff: 204.70,
             	conf: 'FusionServer XH620 V3 Cluster, Xeon E5-2650v4 12C 2.2GHz, Infiniband QDR',
             	color: '#9400D3'
             },
            ...
            
             {
             	rank: 482,
             	eff: 315.00,
             	conf: 'FusionServer XH620 V3 Cluster, Xeon E5-2667v4 8C 3.2GHz, 10G Ethernet',
             	color: '#9400D3'
             },
            ...
            
             {
             	rank: 483,
             	eff: 77.35,
             	conf: 'PRIMERGY CX1640 M1, Intel Xeon Phi 7210 64C 1.3GHz, Intel Omni-Path',
             	color: '#00008B'
             },
            ...
            
             {
             	rank: 490,
             	eff: 394.90,
             	conf: 'RH1288 V3 Cluster, Xeon E5-2680v3 12C 2.5GHz, Infiniband FDR',
             	color: '#9400D3'
             },
...
<option value="49" selected="selected">June 2017</option>
...
<option value="os">Operating System</option>
 ...
 <span style="color: #FF1493">Hitachi/Fujitsu</span>,
 

 <span style="color: #556B2F">Lenovo/IBM</span>,
 

 <span style="color: #696969">PEZY Computing / Exascaler Inc.</span>,
 

 <span style="color: #A9A9A9">Nvidia</span>,
 

 <span style="color: #FF8C00">NEC/HPE</span>,
 

 <span style="color: #8FBC8F">Inspur</span>,
 

 <span style="color: #9400D3">Huawei</span>,
 

 <span style="color: #E9967A">T-Platforms</span>,
 

 <span style="color: #008B8B">Dell EMC</span>,
 

 <span style="color: #00CED1">Sugon</span>,
 

 <span style="color: #ADFF2F">ClusterVision</span>,
 

 <span style="color: #FF69B4">Adtech</span>,
 

 <span style="color: #B22222">Dell / Intel</span>,
 

 <span style="color: #2F4F4F">Fujitsu / Lenovo / Xenon</span>,
 

 <span style="color: #FFFFF0">MEGWARE</span>,
 

 <span style="color: #4B0082">IPE, Nvidia, Tyan</span>,
 

 <span style="color: #DC143C">Cray Inc.</span>,
 

 <span style="color: #808080">NEC/MEGWARE</span>,
 

 <span style="color: #BDB76B">Bull</span>,
 

 <span style="color: #DCDCDC">ACTION</span>,
 

 <span style="color: #6495ED">NUDT</span>,
 

 <span style="color: #B8860B">Lenovo</span>,
 

 <span style="color: #1E90FF">NEC</span>,
 

 <span style="color: #FF00FF">Intel</span>,
 

 <span style="color: #CD5C5C">DALCO</span>,
 

 <span style="color: #483D8B">ExaScaler</span>,
 

 <span style="color: #006400">Self-made</span>,
 

 <span style="color: #8B008B">IBM/Lenovo</span>,
 

 <span style="color: #00008B">Fujitsu</span>,
 

 <span style="color: #9932CC">Penguin Computing</span>,
 

 <span style="color: #8B0000">Atipa</span>,
 

 <span style="color: #A9A9A9">HPE</span>,
 

 <span style="color: #696969">Megatel/Action</span>,
 

 <span style="color: #008000">Supermicro</span>,
 

 <span style="color: #2F4F4F">T-Platforms, Intel, Dell</span>,
 

 <span style="color: #808080">E4 Computer Engineering S.p.A.</span>,
 

 <span style="color: #F0E68C">Oracle</span>,
 

 <span style="color: #228B22">NSSOL/HPE</span>,
 

 <span style="color: #FF7F50">NRCPC</span>,
 

 <span style="color: #DAA520">RSC Group</span>,
